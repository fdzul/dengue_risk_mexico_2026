...
chik <- data.table::fread("/Users/fdzul/Library/CloudStorage/Dropbox/dataset/dge/chik/2026/CHIKUNGUNYA2_.txt",
                          encoding = "Latin-1") |>
    dplyr::filter(ESTATUS_CASO %in% c(1, 2)) |>
    #dplyr::filter(ES_MIGRANTE %in% c(2)) |>
    dplyr::mutate(CVE_EDO_REP = stringr::str_pad(CVE_EDO_REP,
...
zika <- data.table::fread("/Users/fdzul/Library/CloudStorage/Dropbox/dataset/dge/zik/2026/ZIKA2_.txt",
                          encoding = "Latin-1") |>
    dplyr::filter(ESTATUS_CASO %in% c(1, 2)) |>
    #dplyr::filter(ES_MIGRANTE %in% c(2)) |>
    dplyr::mutate(CVE_EDO_REP = stringr::str_pad(CVE_EDO_REP,
...
link <- tibble::tibble(CVE_ENT = c("01","03","04","06","07",
                                   "11","12", "14",
                                   "16","18", "20",
                                   "23", "25", "26", "27", 
                                   "30", "31"),
                       link = c("https://chimerical-kitsune-1b8f97.netlify.app", # 01 Aguascalientes
                                "https://inquisitive-marshmallow-a2510b.netlify.app",
